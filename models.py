from sqlalchemy import Column, Integer, String, Date, ForeignKey, Text, Boolean, Float, Time
...
class Hotel(Base):
    ...
    # ✅ Esta línea se enlaza con hotel en ReservaHotel
    reservas_hotel = relationship("ReservaHotel", back_populates="hotel")
...
class ReservaHotel(Base):
    ...
    # ✅ Esta línea se enlaza con Socio
    socio = relationship("Socio", back_populates="reservas_hotel")

    # ✅ Esta se enlaza con Hotel, pero Hotel debe tener back_populates también
    hotel = relationship("Hotel", back_populates="reservas_hotel")
